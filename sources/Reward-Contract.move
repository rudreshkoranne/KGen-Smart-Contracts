module KGen::reward_contract {
    ...
    public entry fun update_performance_metrics(_owner: &signer, oracle_address: address, uptime: u64, accuracy: u64)  {
        oracle_management::update_performance_metrics(_owner, oracle_address, uptime, accuracy);
    }
